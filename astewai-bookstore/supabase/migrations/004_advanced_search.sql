...
-- Add popular searches tracking table
...
-- Add bundles to search functionality
ALTER TABLE bundles ADD COLUMN IF NOT EXISTS search_vector tsvector;

-- Create function to update bundle search vector
...
-- Create trigger for bundle search vector
