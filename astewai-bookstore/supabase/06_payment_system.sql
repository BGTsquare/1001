-- MODULE 6: PAYMENT SYSTEM (Standalone migration)
-- This file creates payment-related tables and helper functions
-- Derived from the project's existing `05_payments.sql` excerpt.
